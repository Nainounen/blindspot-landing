...
export default function HowItWorks() {
  return (
    <section id="how" style={{ padding: "120px 40px", maxWidth: 1200, margin: "0 auto" }}>
      ...
      <div className="reveal" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 2, background: "var(--border)", borderRadius: 20, overflow: "hidden", transitionDelay: "0.1s" }}>
        {steps.map((s) => (
